...
long long PokerSolver::estimate_tree_memory(std::string range1,std::string range2,std::string board){
...
void PokerSolver::dump_strategy(std::string dump_file,int dump_rounds) {
