...
// vs 4bet: KK should jam
check('KK vs 4bet jam', getFreq(ps.getStrategy('BTN', 'KK', 'vs_4bet'), 'jam'), 100, 5);

// vs 4bet: 43o should fold
check('43o vs 4bet fold', getFreq(ps.getStrategy('BTN', '43o', 'vs_4bet'), 'fold'), 95, 10);
